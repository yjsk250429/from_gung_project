...
const Schedule = ({ thisitem }) => {
    ...
    }, [daysCount, category, thisitem.id]);
    ...
    return (
        <div className="schedule">
                ...
                <Swiper slidesPerView="auto" grabCursor={true} className="days">
                    {Array(daysCount)
                        ...
                        .map((_, dayIdx) => {
                            ...
                            // 이미지 3개 랜덤 추출
                            const dayImages = fixedDayImages[dayIdx];
                                    ...
                                    <article className={`day ${dayClassName}`}>
                                        ...
                                        <ul>
                                            {dayImages.map(({ img, title }, idx) => (
                                                <Fragment key={`day${dayIdx}-img${idx}`}>
                                                    <li>
            ...
            <p className="btns">
                ...
                >
                    <i>{isWished ? <FaHeart style={{ color: 'red' }} /> : <FiHeart />}</i>
                    투어 찜하기
                </button>
