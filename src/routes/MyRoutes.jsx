  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/tourclass/:tourclassID" element={<Navigate to="/home/tourclass/:tourclassID" replace />} />
        ...
        <Route path="/ott/:mediaType/:ottID" element={<Navigate to="/home/ott/:mediaType/:ottID" replace />} />
