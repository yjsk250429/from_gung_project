...
const Section3 = () => {
    ...
    useEffect(() => {
        ...
        timeline
            ...
            .to(cardTopRightRef.current, {
                x: 0,
                opacity: 1,
                duration: 1.2,
                ease: "power2.out"
            }, 0.1)
            .to(cardBottomRightRef.current, {
                x: 0,
                opacity: 1,
                duration: 1.2,
                ease: "power2.out"
        ...
        <div className="section3-main" ref={sectionRef}>
            ...
            <div className="s3_card s3_card--bottom-left" ref={cardBottomLeftRef}>
                ...
                <div className="card-content">
                    ...
                    <p>
                        고운 색감과 우아한 곡선을 간직한<br />
                        한복을 직접 입어보며,<br />
                        한국의 미와 전통을 몸소 느껴보는<br />
                        특별한 하루를 경험하세요.
                    </p>
                </div>
            </div>
            ...
            <div className="s3_card s3_card--bottom-right" ref={cardBottomRightRef}>
                ...
                <div className="card-content">
                    ...
                    <p>
                        다섯 가지 빛깔의 재료가 어우러져<br />
                        한 그릇에 담기는 한국의 맛.<br />
                        직접 손으로 비벼며 만들어가는<br />
                        과정에서 한국 음식의 멋과 정을<br />
                        느껴 수 있습니다.
                    </p>
                </div>
            </div>
