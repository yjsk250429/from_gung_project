...
import { DetailReviews, Schedule, SelectDate } from '../../components/tourclassDetail';
                ...
                <article className="right">
                    ...
                    <div className="basic-info">
                        <h3>
                            {title}
                            <span className="rate">
                                평점 {renderStars(thisitem.rating?.rate || 0)}
                            </span>
                        </h3>
                    ...
                    <div className="group">
                        ...
                        {activeTab === 2 && <DetailReviews thisitem={thisitem} />}
                    </div>
                </article>
            </div>
            <CouponDown />
